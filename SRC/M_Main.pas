...
uses
  ...
  Vcl.ComCtrls, vcl.wwriched, System.Net.URLClient, System.Net.HttpClient, System.Net.HttpClientComponent;
...
procedure TM_mainFRM.Client1RequestCompleted(const Sender: TObject; const AResponse: IHTTPResponse);
begin
ShowMessage(AResponse.ContentAsString());
end;
